...
namespace Recaudacion.Helpers
{
    public class Captcha
    {
        ...
        public void GenerateImage()
        {
            ...
            HatchBrush hatchBrush = new HatchBrush(HatchStyle.SmallConfetti, Color.FromArgb(114, 172, 236), Color.FromArgb(255, 190, 97));
            ...
            // Draw the text.
            hatchBrush = new HatchBrush(HatchStyle.SmallConfetti,
                                        Color.White,
                                        Color.White);
